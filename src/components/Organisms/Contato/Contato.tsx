...
const Contato: React.FC<IContatoProps> = ({ translations }) => {
  ...
  return (
    <div className="seventh-section container top-spacing">
      <div className="contact">
        <Text
          as="h2"
          text={`${translations.contato.title}`}
        ...
        <div className="form-fields">
          <div className="form-field">
            <Text
              as="p"
              text={`${translations.contato.label1}`}
          ...
          <div className="form-field">
            <Text
              as="p"
              text={`${translations.contato.label2}`}
              className="contact-form-title"
            />
            <Input
              type="email"
          ...
          <div className="form-field">
            <Text
              as="p"
              text={`${translations.contato.label3}`}
              className="contact-form-title"
            />
            <Input
              type="text"
          ...
          <div className="form-field">
            <Text
              as="p"
              text={`${translations.contato.label4}`}
              className="contact-form-title"
            />
            <Input
              type="text"
